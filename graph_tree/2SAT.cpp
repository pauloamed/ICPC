// https://github.com/brunomaletta/Biblioteca/blob/master/Codigo/Matematica/2SAT.cpp

#include <bits/stdc++.h>
using namespace std;

/*
solve() retorna um par, o first fala se eh possivel atribuir
o second fala a avaliacao de cada variavel nessa atribuicao

every proposition has an id X; ~X is its negation
*/
